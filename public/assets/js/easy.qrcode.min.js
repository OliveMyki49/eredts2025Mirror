...
!(function () {
    ...
    (i = (function (a, b) {
          ...
          if (((i = e[n[f]]), (j = this[n[f]]), i.apply))
            if (j instanceof h) {
              ...
              if (
                ...
                (l = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi),
                  (m = l.exec(j)),
                  c.setAttribute(
                    i.svgAttr,
      ...
      (f.prototype.getSerializedSvg = function (a) {
        ...
        if (
          ((g = /xmlns="http:\/\/www\.w3\.org\/2000\/svg".+xmlns="http:\/\/www\.w3\.org\/2000\/svg/gi),
          g.test(h) &&
            (h = h.replace(
              ...
              return (
                (e.prototype.draw = function (a) {
                  ...
                  function c(a) {
                    function c(a) {
                      ...
                      (h.imageSmoothingEnabled = !0),
                        ...
                        (h.imageSmoothingEnabled = o),
                        (h.imageSmoothingQuality = n),
                        b(),
                        (s._bIsPainted = !0),
                        s.makeImage();
                    }
                  ...
                  (h.lineWidth = 0),
                    ...
                    h.clearRect(d.quietZone, d.quietZone, d.width, d.titleHeight);
                  var i = this;
