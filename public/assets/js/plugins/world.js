!(function (t, e) {
            ...
            return (
                ...
                (e.addClass = function (t) {
                    return this.selector.classList
                        ...
                        : (-1 ==
                              this.selector.className.split(" ").indexOf(t) &&
        ...
        y = (function (t) {
            ...
            return (
                (i.setStyle = function (t, e) {
                    var i;
                    f.isObj(t)
                        ? f.merge(this.style.current, t)
                        : f.merge(this.style.current, (((i = {})[t] = e), i));
                    this.updateStyle();
                }),
                (i.updateStyle = function () {
                    var t = {};
                    f.merge(t, this.style.initial),
                        f.merge(t, this.style.current),
                        this.isHovered && f.merge(t, this.style.hover),
                        this.isSelected &&
                            (f.merge(t, this.style.selected),
                            this.isHovered &&
                                f.merge(t, this.style.selectedHover)),
                        this.set(t);
                }),
                e
            );
        ...
        w = (function (t) {
            function e(e) {
                ...
                return (
                    ...
                    (i._defsElement = new v("defs")),
                    (i._rootElement = new v("g", {
            ...
            return (
                ...
                (i.createPath = function (t, e) {
                    ...
                    return (
                        i.node.setAttribute("fill-rule", "evenodd"), this.add(i)
                    );
                }),
                ...
                (i.add = function (t, e) {
                    return (
                        (e = e || this._rootElement).node.appendChild(t.node), t
                    );
                }),
                e
            );
    ...
    function k(t, e, i) {
        var s = f.$(e),
            a =
                -1 === s.attr("class").indexOf("jvm-region")
                    ? "marker"
                    : "region",
            ...
            return (
                ...
                (e._setStatus = function (t, e) {
                    (this.shape[t] = e),
                        ...
                        (this[t] = e),
                        this.label &&
                            ((this.label[t] = e), this.label.updateStyle());
                }),
                t
            );
        })(),
    ...
    var E = (function (t) {
        function e(e) {
            ...
            return (
                ...
                (i.shape = h.canvas[
                    i._isImage ? "createImage" : "createCircle"
                ](
                    {
                        dataIndex: s,
                        cx: n,
    ...
    var Y = {
        ...
        lcc: function (t, e, i) {
            var s = i * this.radDeg,
                ...
                l =
                    (Math.cos(r) * Math.pow(Math.tan(Math.PI / 4 + r / 2), h)) /
                    h,
    ...
    (Y.degRad = 180 / Math.PI),
        (Y.radDeg = Math.PI / 180),
        (Y.radius = 6381372);
    var L = (function () {
        function t(t, e) {
            var i = t.scale,
    ...
    var T = Object.freeze({
                    ...
                    this.params.zoomOnScroll &&
                        this.container.on(
                            ...
                            function (t) {
                                var e = 0;
                                (e =
                                    (t.deltaY || -t.wheelDelta || t.detail) >>
                                        10 || 1),
                                    (e *= 75);
                                var s =
                                        i.container.selector.getBoundingClientRect(),
                    ...
                    h = function (h) {
                        ...
                        if (("touchstart" == h.type && (n = 0), 1 == d.length))
                            ...
                            if (2 == n)
                                ...
                                var f =
                                    o.container.selector.getBoundingClientRect();
                                (l = {
                                    ...
                                    (a =
                                        d[0].pageX > d[1].pageX
                                            ? d[1].pageX +
                                              (d[0].pageX - d[1].pageX) / 2
                                            : d[0].pageX +
                                              (d[1].pageX - d[0].pageX) / 2),
                                    (r =
                                        d[0].pageY > d[1].pageY
                                            ? d[1].pageY +
                                              (d[0].pageY - d[1].pageY) / 2
                                            : d[0].pageY +
            ...
            createLines: function (t, e, i) {
                ...
                for (var o in ((this.linesGroup =
                    this.linesGroup ||
                    this.canvas.createGroup("jvm-lines-group")),
                t)) {
                    var h = t[o];
                    for (var l in e) {
            ...
            resize: function () {
                ...
                this.defaultWidth / this.defaultHeight
                    ? ((this.baseScale = this.height / this.defaultHeight),
                      (this.baseTransX =
                          Math.abs(
                              this.width - this.defaultWidth * this.baseScale
                          ) /
                          (2 * this.baseScale)))
            ...
            setScale: function (t, e, i, s, a) {
                var r,
                    ...
                    v = Math.abs(
                        Math.round(
                            (60 * (t - this.scale)) / Math.max(t, this.scale)
                        )
                    );
            ...
            coordsToPoint: function (t, e) {
                ...
                return (
                    ...
                    !!(s = this.getInsetForPoint(i.x, i.y)) &&
                        ((a = s.bbox),
                        (i.x =
                            ((i.x - a[0].x) / (a[1].x - a[0].x)) *
                            s.width *
                            this.scale),
                        (i.y =
                            ((i.y - a[0].y) / (a[1].y - a[0].y)) *
                            s.height *
                            this.scale),
                        {
                            x:
        ...
        z = (function () {
            ...
            return (
                (e.init = function (t) {
                    var e = this.params;
                    (this.container = f.$(t).addClass("jvm-container")),
                        (this.canvas = new w(
                            this.container,
                            this.width,
                            this.height
                        ...
                        this.repositionLabels(),
                        e.showTooltip && this.createTooltip(),
                        e.zoomButtons && this.handleZoomButtons(),
                        e.selectedRegions &&
                            this.setSelected("regions", e.selectedRegions),
                        e.selectedMarkers &&
                            this.setSelected("markers", e.selectedMarkers),
                ...
                (e.emit = function (t, e) {
                    for (var i in A)
                        A[i] === t &&
                            f.isFunc(this.params[i]) &&
                            this.params[i].apply(this, e);
                }),
                ...
                (e.addMarker = function (t) {
                    console.warn(
                        "`addMarker` method is depreacted, please use `addMarkers` instead."
                    ),
