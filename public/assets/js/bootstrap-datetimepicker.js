...
(function (factory) {
    ...
    function timeZoneAbbreviation() {
        ...
        formattedStr =
            ((ref = date.split("(")[1]) != null ? ref.slice(0, -1) : 0) ||
            date.split(" ");
    ...
    var Datetimepicker = function (element, options) {
        ...
        this.zIndex =
            options.zIndex || this.element.data("z-index") || undefined;
        this.title =
            typeof options.title === "undefined" ? false : options.title;
        ...
        this.clearBtn =
            options.clearBtn || this.element.data("date-clear-btn") || false;
        this.todayHighlight =
    ...
    Datetimepicker.prototype = {
        ...
        update: function () {
            ...
            if (typeof date === "string") {
                if (
                    new RegExp(this.hour_minute).test(date) ||
        ...
        fill: function () {
            ...
            while (prevMonth.valueOf() < nextMonth) {
                ...
                if (
                    ...
                    $.inArray(prevMonth.toDateString(), this.datesDisabled) !==
                        -1
                ) {
            ...
            for (var i = 0; i < 24; i++) {
                ...
                if (
                    actual.valueOf() + 3600000 <= this.startDate ||
    ...
    var DPGlobal = {
        ...
        parseDate: function (date, format, language, type, timezone) {
            ...
            var parts =
                    (date && date.toString().match(this.nonpunctuation)) || [],
