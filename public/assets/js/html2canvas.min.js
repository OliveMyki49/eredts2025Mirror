...
!(function (A, e) {
      ...
      PA =
        ...
        (XA.prototype.consumeEscapedCodePoint = function () {
          ...
          if (lA(e)) {
            ...
            var r = parseInt(t, 16);
            return 0 === r || (55296 <= (A = r) && A <= 57343) || 1114111 < r
              ? 65533
              : r;
          }
          return -1 === e ? 65533 : e;
    ...
    function He(A, e) {
      return (
        (A = ue(A, e[0])),
        (e = e[1]) && te(e) ? { color: A, stop: e } : { color: A, stop: null }
      );
    }
    function pe(A, t) {
      var e = A[0],
    ...
    var br,
      ...
      Xr = {
        get SUPPORT_RANGE_BOUNDS() {
          ...
          return (
            Object.defineProperty(Xr, "SUPPORT_RANGE_BOUNDS", { value: A }), A
          );
        },
        get SUPPORT_WORD_BREAKING() {
          ...
          return (
            Object.defineProperty(Xr, "SUPPORT_WORD_BREAKING", { value: A }), A
          );
        },
        get SUPPORT_SVG_DRAWING() {
          ...
          return (
            Object.defineProperty(Xr, "SUPPORT_SVG_DRAWING", { value: A }), A
          );
        },
        ...
        get SUPPORT_CORS_IMAGES() {
          ...
          return (
            Object.defineProperty(Xr, "SUPPORT_CORS_IMAGES", { value: A }), A
          );
        },
        get SUPPORT_RESPONSE_TYPE() {
          var A = "string" == typeof new XMLHttpRequest().responseType;
          return (
            Object.defineProperty(Xr, "SUPPORT_RESPONSE_TYPE", { value: A }), A
          );
        },
    ...
    function QB(A, e) {
      ...
      return (
        ...
        (t.svg =
          "data:image/svg+xml," + encodeURIComponent(r.serializeToString(e))),
      ...
      try {
        e.contentWindow &&
          ...
          (r = e.contentWindow.document.body
            ? fe(
                A,
                getComputedStyle(e.contentWindow.document.body).backgroundColor
              )
            : Le.TRANSPARENT),
      ...
      dn =
        ...
        (fn.prototype.createStyleClone = function (A) {
          try {
            ...
            if (
              (this.context.logger.error("Unable to access cssRules property", A),
    ...
    var As,
      es = function (A) {
        ...
        (this.topLeftBorderDoubleOuterBox =
          0 < r || 0 < B
            ? ss(t.left + F / 3, t.top + l / 3, r - F / 3, B - l / 3, As.TOP_LEFT)
      ...
      (this.container = A),
        ...
        0 !== this.container.styles.overflowX &&
          ...
          ns(t, r)
            ...
            : (this.effects.push(new is(t, 2)), this.effects.push(new is(r, 4))));
    }
    function ws(A, e) {
      switch (e) {
        case 0:
        ...
        Q.container.elements.forEach(function (A) {
          ...
          e || t
            ? ((B = e || A.styles.isPositioned() ? a : c),
              ...
              hs(r, t, e ? t : a, i))
            : ((A.styles.isInlineLevel() ? c.inlineLevel : c.nonInlineLevel).push(
                r
              ),
              hs(r, c, a, i)),
            Pt(A.flags, 8) && ds(A, i);
    ...
    var Ls,
      ...
      bs =
          ...
          return a(this, void 0, void 0, function () {
            ...
            return H(this, function (A) {
              switch (A.label) {
                ...
                case 5:
                  return (
                    A.trys.push([5, 7, , 8]), [4, this.context.cache.match(e.src)]
                  );
                case 6:
                  return (
                    (Q = A.sent()), this.renderReplacedElement(e, t, Q), [3, 8]
                  );
                case 7:
                  return (
                    A.sent(),
                ...
                case 10:
                  return (
                    (Q = A.sent()), this.renderReplacedElement(e, t, Q), [3, 12]
                  );
                case 11:
                  return (
                    A.sent(),
                ...
                case 15:
                  return (
                    A.trys.push([15, 17, , 18]), [4, this.context.cache.match(c)]
                  );
                case 16:
                  return (
                    (Q = A.sent()),
        ...
        (Ds.prototype.resizeImage = function (A, e, t) {
          ...
          var r = (null !== (r = this.canvas.ownerDocument) && void 0 !== r
            ? r
            : document
            ...
            return H(this, function (A) {
              switch (A.label) {
                ...
                case 7:
                  return 4 !== i.style
                    ? [3, 9]
                    : [4, this.renderDoubleBorder(i.color, i.width, n, c.curves)];
                case 8:
                  return A.sent(), [3, 11];
                case 9:
            ...
            switch (A.label) {
              case 0:
                ...
                return (
                  ...
                  (c = {
                    ...
                    scrollX:
                      null !== (g = F.scrollX) && void 0 !== g
                        ...
                        : t.pageXOffset,
                    scrollY:
                      null !== (w = F.scrollY) && void 0 !== w ? w : t.pageYOffset
                  }),
                  (a = new d(
                    c.scrollX,
                    c.scrollY,
                  ...
                  (g = new Ps(U, a)),
                  (c =
                    null !== (w = F.foreignObjectRendering) && void 0 !== w && w),
                  (w = {
                    allowTaint: null !== (U = F.allowTaint) && void 0 !== U && U,
                    onclone: F.onclone,
              ...
              case 1:
                ...
                (l = {
                  ...
                  width:
                    null !== (l = F.width) && void 0 !== l ? l : Math.ceil(B),
                  height:
                    null !== (l = F.height) && void 0 !== l ? l : Math.ceil(n)
                }),
                c)
                  ? (g.logger.debug(
