...
(function () {
    ...
    Label.prototype.renderBaseLabel = function (label, position) {
        ...
        if (typeof label === 'object') {
            ...
            if(this.chart.config.type === 'horizontalBar'){ //move render to the right 
                ctx.save();
                ...
                for (var i = 0; i < lines.length; i++) {
                    ...
                    y += 1; //align center vertically by adding 1 in every iteration of y axis
                    ctx.fillText(lines[i], position.x - 12, y); //custom render move render value inside horizontal bar
                }
                ctx.restore();
            }else{
                ctx.save();
