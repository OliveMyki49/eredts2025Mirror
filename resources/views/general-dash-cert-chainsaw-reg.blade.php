...
<body class="g-sidenav-show  bg-gray-200" oncontextmenu="return false;">
    ...
    {{-- {{ dd($doc_info) }} --}}
    <input type="hidden" id="qrval" value="{{ asset('/get-routingslip' . '/' . $doc_info->doc_no) }}">
        ...
        <div class="invoice-box">
            ...
            <table id="printable" class="m-0 p-0" cellpadding="0" cellspacing="0">
                <thead>
                                ...
                                <tr class="m-0 p-0">
                                    <td class="m-0 p-0 text-center">
                                        ...
                                        <div style="text-align: center; position:relative;">
                                            ...
                                            <p style="display:inline-block; vertical-align:middle; margin-right: 40px;">
                                                <span class="fs-6"><b style="color: #000; text-shadow: 1px 1px rgba(134, 134, 134, 0.5)">Republic of the Philippines</b></span>
                                                <br>
                                                ...
                                                @endif
                                                @php
                                                    $header_title = strtolower($user_office->header_office_title);

                                                    if ($header_title == null) {
                                                        $header_title = 'DEPARTMENT OF ENVIRONMENT AND NATURAL RESOUCES';
                                                    }
                                                @endphp
                                                <span class="fs-5"><b style="color: #249200; text-shadow: 1px 1px rgba(134, 134, 134, .5); text-transform: capitalize;">{{ $header_title }}</b></span>
                                                <br>
                                                @if ($user_office->office_address != null)
                                                    <span class="fs-6"><b style="color: #000; text-shadow: 1px 1px rgba(134, 134, 134, 0.5)">{{ $user_office->office_address }}</b></span>
                                                @endif
                                                <br>

                                            </p>
                                            {{-- <div class="qrcontainer" style="position: absolute; top: -15px; right:0;"> --}}
                    ...
                    {{-- region certificaiton title --}}
                    <tr>
                        <td colspan="2">
                            <table class="my-3 p-0">
                                <tr class="m-0 p-0">
                                    <td class="m-0 ps-1 text-center" style="letter-spacing: 1px;color: #188b00; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: black;">
                                        <h2><b>CERTIFICATE OF CHAINSAW REGISTRATION</b></h2>
                                    </td>
                                </tr>
                                <tr class="m-0 p-0">
                                    <td class="m-0 ps-1 text-center">
                                        <div class="row m-0">
                                            <div class="col text-center fw-bold">
                                                Control No. {{ strtoupper($doc_info->doc_no) }}
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <tr class="information">
                        <td class="p0" colspan="2">
                            ...
                            <div class="row m-0 mt-2">
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            {{ strtoupper($doc_stats[0]->referred_by_full_office_name) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <br>
                            <div class="row m-0">
                                <div class="col border border-dark fw-bold text-center">ROUTING AND ACTION INFORMATION</div>
                            </div>
                        </td>
                    </tr>
                    {{-- endregion header --}}
