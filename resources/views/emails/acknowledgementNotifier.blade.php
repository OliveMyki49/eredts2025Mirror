...
<head>
    ...
    <title>DENRV RFSOATS EMAIL</title>
</head>
    ...
    <div style="
		...
		border-radius: 10px;">
            <p style="font-size: 20px;color: white;">
                ...
                <br>
                Good day! you have successfully submitted a "<span style="font-weight: bold; cursor: pointer;">{{ $dt['request_type'] }}</span>" request to office "<span style="font-weight: bold; cursor: pointer;">{{ $dt['office_receiving_req'] }}</span>" in the <a href="http://rfsoats.duckdns.org:9133/" target="_blank" style="color:beige">REGIONAL FRONTLINE SERVICES ONLINE APPLICATION AND TRACKING SYSTEM</a> 
                with the document id "<span style="font-weight: bold; cursor: pointer;">CRDID{{ $dt['doc_id'] }}</span>" (NOTE: This is not the "DOCUMENT TRACKING NUMBER")
                <br>

                {{-- CRDID is a made up name which means "Client Request Document ID: " --}}
            </p>
            <p style="font-size: 20px;color: white;">
                Document tracking number will be sent to your email once validated and approved, Please check your email for updates
                <br>
            </p>
