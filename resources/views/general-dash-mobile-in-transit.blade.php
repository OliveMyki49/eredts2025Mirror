...
<div class="modal fade" id="vDIITModal" tabindex="-1" aria-labelledby="vDIITLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h1 class="modal-title fs-5 text-white" id="vDIITLabel">REQUEST INFORMATION</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="text-center fs-3 border border-3 vDIITheader-status">REQUESTEE INPUTS AND ATTACHMENTS
                STATUS UNKNOWN
            </div>
                ...
                <div class="accordion" id="vDIIT_accordian">
                    ...
                    <form class="p-0" id="addvDIITForm">
                        ...
                        <div class="accordion-item" style="display: none;">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#vDIIT_collapsible_pymnt_stat" aria-expanded="false" aria-controls="vDIIT_collapsible_pymnt_stat">
                                    PAYMENT STATUS
                                </button>
                            </h2>
                            <div id="vDIIT_collapsible_pymnt_stat" class="accordion-collapse collapse" data-bs-parent="#vDIIT_accordian">
                                <div class="accordion-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                ...
                                                <div class="col-12 pt-3 px-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md px-5 mb-3">
                                                            <label for="none" class="vDocAtchInTrnst_ofp_signed_link"></label><br>
                                                            <label for="none" class="vDocAtchInTrnst_cli_rcpt_link"></label>
                                                            <div class="vDocAtchInTrnst-ofp-and-rcpt-uploads"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row m-3 border border-secondary">
                                                        ...
                                                        @if ($acc_id == 10 || $acc_id == 11 || $acc_id == 12 || $acc_id == 14)
                                                            <div class="col-6">
                                                                <div class="row pe-4">
                                                                    ...
                                                                    <div class="p-0 col-3 border-bottom border-dark fw-bold vDIIT_per_bill_no"></div>
                                                                    <div class="p-0 col-1"></div>
                                                                    <div class="p-0 col-2 text-end">Dated: &nbsp;</div>
                                                                    <div class="p-0 col-4 border-bottom border-dark fw-bold vDIIT_per_bill_no_dated"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6"></div>
                                                ...
                                                <div class="col-12 px-5 vDIIT_prev_cost_breakdown"></div>
                                                <div class="col-12 px-5 pb-3 vDIIT_prev_ttl_cost"></div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="vDIITremarks" class="form-label fs-6 fw-bold">Document Remarks: <span class="text-primary">(optional)</span></label>
                                                        <input type="text" id="vDIITremarks" name="remarks" class="form-control toUpperCase" placeholder="Document remarks here...">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="vDIITin_transit_remarks" class="form-label fs-6 fw-bold">In-Transit Remarks: <span class="text-primary">(optional)</span></label>
                                                        <input type="text" id="vDIITin_transit_remarks" name="in_transit_remarks" class="form-control toUpperCase" placeholder="In-Transit remarks here...">
                                                    </div>
                                                </div>
    ...
    $(function() {
        ...
        function dTInTransit_func() {
            ...
            $('#dTInTransit').dataTable({
                    ...
                    /* Doc Attachments */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let req_atchs_collapsible = '' +
                                ...
                                '    <a class="fs-6" data-bs-toggle="collapse" href="#doc_clps_atch_DIIT' + row['id'] + '" role="button" aria-expanded="false" aria-controls="doc_clps_atch_DIIT' + row['id'] + '">' +
                                '        Show Files' +
                                '    </a>' +
                                '</p>' +
                ...
                order: [
                    [12, 'desc'] /* update by last updated action */
                ],
                lengthChange: true,
                "pageLength": 10,
                dom: 'Bprtip',
        ...
        $('button.btn_collapse_tabInTransit').click(function() {
            if (tabInTransit == false) {
                dTInTransit_func();
                tabInTransit = true;
            }

            $('.currently_viewing').empty().append('In-Transit');
        });
...
<script>
    $(function() {
            ...
            $.ajax({
                ...
                success: function(r) {
                    if (r.success) {
                        ...
                        $('.vDIIT_content').append('' +
                            '<div class="col-md-12 mb-2 fs-6">Client Address: <br><span class="fw-bold fs-6">' + client_address + '</span></div>' +
                            '<hr>' +
                            ''
                        );
                        ...
                        $('.vDocAtchInTrnst_ofp_signed_link').empty(); //remove link viewable for uploaded oop or receipt
                        $('.vDocAtchInTrnst_cli_rcpt_link').empty(); //remove link viewable for uploaded oop or receipt
                        $('.vDocAtchInTrnst-ofp-and-rcpt-uploads').empty(); //remove link viewable for uploaded oop or receipt
                        if (order_of_payment != null) {

                            // region get order of payment uploaded document links
                            if (order_of_payment.order_of_payment != null) {
                                $('.vDocAtchInTrnst_ofp_signed_link').empty().append('<a class="link-primary fs-6" href="' + order_of_payment.order_of_payment + '" target="_blank"><i class="fa fa-file-o" aria-hidden="true"></i> Order of payment</a>');
                            }

                            if (order_of_payment.payment_receipt != null) {
                                $('.vDocAtchInTrnst_cli_rcpt_link').empty().append('<a class="link-primary fs-6" href="' + order_of_payment.payment_receipt + '" target="_blank"><i class="fa fa-file-o" aria-hidden="true"></i> Receipt</a>');
                            }

                            if (order_of_payment.order_of_payment == null && order_of_payment.payment_receipt == null) {
                                $('.vDocAtchInTrnst-ofp-and-rcpt-uploads').empty().append('<div class="text-center text-danger fs-6">- - - No uploaded documents - - -</div>');
                            }
                            // endregion get order of payment uploaded document links

                            //perbill
                            $('.vDIIT_per_bill_no').empty().append(order_of_payment.per_bill_no);
                            $('.vDIIT_per_bill_no_dated').empty().append(order_of_payment.per_bill_no_dated);

                            //cost
                            if (cost_breakdown.length != 0) {
                                $('.vDIIT_prev_cost_breakdown').empty().append('' +
                                ...
                                cost_breakdown.forEach(dt => {
                                    $('.vDIIT_prev_cost_breakdown').append('' +
                                ...
                                if (total_of_cost_break_down == order_of_payment.pay_amount) {
                                    ...
                                    //show total cost
                                    $('.vDIIT_prev_ttl_cost').empty().append('' +
                                ...
                                $('.vDIIT_prev_cost_breakdown').empty(); //clear the cost breakdown
                            ...
                            $('.vDIIT_prev_cost_breakdown').empty();

                            //reset bill no
                            $('.vDIIT_per_bill_no').empty()
                            $('.vDIIT_per_bill_no_dated').empty()
        ...
        $('.btn-viewDocInfoReceived-receive').click(function() {
            ...
            let action_id = $('#vDIITaction_id').val();
            let doc_id = $('#vDIITdoc_id').val();
        ...
        $('.btn-cVIITIreencryptId').click(function() {
            let client_id = $('#cVIITIreencryptId').val();
