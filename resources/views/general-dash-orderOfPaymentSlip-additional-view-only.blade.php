                                ...
                                <td class="px-5 pb-4" colspan="2">
                                    <div class="row m-0 justify-content-end">
                                        ...
                                        <div class="col-2 border-bottom border-dark text-center">
                                            <input type="text" class="border-0 fs-12 bg-transparent text-start" id="or_no" name="or_no" oninput="this.style.width = ((this.value.length * 25) + 5) + 'px';" placeholder="" value="{{ $ofp != null ? $ofp->or_no : '' }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row m-0 justify-content-end">
                                        <div class="col-1 text-start fw-bold">
