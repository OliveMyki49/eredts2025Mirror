...
<div class="modal fade" id="vDIAviewClientIdModal" tabindex="-1" aria-labelledby="vDIAviewClientIdLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #497ac1">
                <h1 class="modal-title fs-5 text-white" id="vDIAviewClientIdLabel">Client ID View</h1>
                <button type="button" class="btn-close btn-vDIAreencryptId" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="height: 800px;">
                <iframe id="vDIAviewClientIdIframe" name="viewClientIdIframe" href="" style="width: 100%; height: 100%;"></iframe>
            </div>
            <div class="modal-footer">
                <input type="hidden" id="vDIAreencryptId">
                <button type="button" class="btn btn-secondary btn-vDIAreencryptId" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="vDIAModal" tabindex="-1" aria-labelledby="vDIALabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #497ac1">
                <h1 class="modal-title fs-5 text-white" id="vDIALabel">Request Information</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body p-0">
                ...
                <div class="accordion" id="vDIA_accordian">
                    ...
                    {{-- region form inputs --}}
                    <form class="p-0" id="addvDIAForm">
                        {{-- Payment Status --}}
                        <div class="accordion-item" style="display: none;">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#vDIA_collapsible_pymnt_stat" aria-expanded="false" aria-controls="vDIA_collapsible_pymnt_stat">
                                    Payment Status
                                </button>
                            </h2>
                            <div id="vDIA_collapsible_pymnt_stat" class="accordion-collapse collapse" data-bs-parent="#vDIA_accordian">
                                <div class="accordion-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                ...
                                                <div class="col-12 pt-3 px-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md px-5 mb-3">
                                                            <label for="none" class="vDocAtchArch_ofp_signed_link"></label><br>
                                                            <label for="none" class="vDocAtchArch_cli_rcpt_link"></label>
                                                            <div class="vDocAtchArch-ofp-and-rcpt-uploads"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row m-3 border border-secondary">
                                                        ...
                                                        @if ($acc_id == 10 || $acc_id == 11 || $acc_id == 12 || $acc_id == 14)
                                                            <div class="col-6">
                                                                <div class="row pe-4">
                                                                    ...
                                                                    <div class="p-0 col-3 border-bottom border-dark fw-bold vDIA_per_bill_no"></div>
                                                                    <div class="p-0 col-1"></div>
                                                                    <div class="p-0 col-2 text-end">Dated: &nbsp;</div>
                                                                    <div class="p-0 col-4 border-bottom border-dark fw-bold vDIA_per_bill_no_dated"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6"></div>
                                                ...
                                                <div class="col-12 px-5 vDIA_prev_cost_breakdown"></div>
                                                <div class="col-12 px-5 pb-3 vDIA_prev_ttl_cost"></div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(function() {
                    ...
                    /* client_name */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let dropdownMenu = '' +
                                ...
                                '               <button ' +
                                '                  type="button" ' +
                                '                  class="btnvDIA-viewClientId btn btn-outline-primary btn-sm" ' +
                                '                  data-bs-toggle="modal" ' +
                                '                  data-bs-target="#vDIAviewClientIdModal"' +
        ...
        $('button.btn_collapse_tabArchived').click(function() {
            if (tabArchived == false) {
                dTArchived_func();
                tabArchived = true;
            }

            $('.currently_viewing').empty().append('Approved');
        });
...
<script>
    $(function() {
        ...
        $('#dTArchived').on('click', '.btn-fetchdocInfo_vDIA', function() {
            ...
            $('#vDIAaction_id').val(action_id);
            $('#vDIAdoc_id').val(doc_id);
            ...
            $.ajax({
                ...
                success: function(r) {
                    if (r.success) {
                        ...
                        $('.vDocAtchArch_ofp_signed_link').empty(); //remove link viewable for uploaded oop or receipt
                        $('.vDocAtchArch_cli_rcpt_link').empty(); //remove link viewable for uploaded oop or receipt
                        $('.vDocAtchArch-ofp-and-rcpt-uploads').empty(); //remove link viewable for uploaded oop or receipt
                        if (order_of_payment != null) {

                            // region get order of payment uploaded document links
                            if (order_of_payment.order_of_payment != null) {
                                $('.vDocAtchArch_ofp_signed_link').empty().append('<a class="link-primary fs-6" href="' + order_of_payment.order_of_payment + '" target="_blank"><i class="fa fa-file-o" aria-hidden="true"></i> Order of payment</a>');
                            }

                            if (order_of_payment.payment_receipt != null) {
                                $('.vDocAtchArch_cli_rcpt_link').empty().append('<a class="link-primary fs-6" href="' + order_of_payment.payment_receipt + '" target="_blank"><i class="fa fa-file-o" aria-hidden="true"></i> Receipt</a>');
                            }

                            if (order_of_payment.order_of_payment == null && order_of_payment.payment_receipt == null) {
                                $('.vDocAtchArch-ofp-and-rcpt-uploads').empty().append('<div class="text-center text-danger fs-6">- - - No uploaded documents - - -</div>');
                            }
                            // endregion get order of payment uploaded document links

                            //perbill
                            $('.vDIA_per_bill_no').empty().append(order_of_payment.per_bill_no);
                            $('.vDIA_per_bill_no_dated').empty().append(order_of_payment.per_bill_no_dated);

                            //cost
                            if (cost_breakdown.length != 0) {
                                $('.vDIA_prev_cost_breakdown').empty().append('' +
                                ...
                                cost_breakdown.forEach(dt => {
                                    $('.vDIA_prev_cost_breakdown').append('' +
                                ...
                                if (total_of_cost_break_down == order_of_payment.pay_amount) {
                                    ...
                                    //show total cost
                                    $('.vDIA_prev_ttl_cost').empty().append('' +
                                ...
                                $('.vDIA_prev_cost_breakdown').empty(); //clear the cost breakdown
                            ...
                            $('.vDIA_prev_cost_breakdown').empty();

                            //reset bill no
                            $('.vDIA_per_bill_no').empty()
                            $('.vDIA_per_bill_no_dated').empty()
        ...
        $('.btn-vDIAreencryptId').click(function() {
            let client_id = $('#vDIAreencryptId').val();
