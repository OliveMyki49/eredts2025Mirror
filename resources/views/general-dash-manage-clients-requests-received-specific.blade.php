{{-- region viewer assigned message --}}
<div class="viewer-assigned-msg">
    {{-- message here --}}
</div>
{{-- region viewer assigned message --}}

{{-- region display table --}}
<table class="table table-striped table-bordered dataTable " id="dtCliReqRecOASpecific" role="grid" aria-describedby="Table" style="width: 100%;" cellspacing="0" width="100%">
...
<div class="modal fade" id="CliReqRecOASpecificviewClientIdModal" tabindex="-1" aria-labelledby="CliReqRecOASpecificviewClientIdLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h1 class="modal-title fs-5 text-white" id="CliReqRecOASpecificviewClientIdLabel">Client ID View</h1>
                <button type="button" class="btn-close btn-CliReqRecOASpecificreencryptId" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="height: 800px;">
                <iframe id="CliReqRecOASpecificviewClientIdIframe" name="viewClientIdIframe" href="" style="width: 100%; height: 100%;"></iframe>
            </div>
            <div class="modal-footer">
                <input type="hidden" id="CliReqRecOASpecificreencryptId">
                <button type="button" class="btn btn-secondary btn-CliReqRecOASpecificreencryptId" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="CliReqRecOASpecificvDocAtchRcvModal" tabindex="-1" aria-labelledby="CliReqRecOASpecific_viewDocAtchTransitLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h1 class="modal-title fs-5 text-white" id="CliReqRecOASpecific_viewDocAtchTransitLabel">Document Attachement: <b><u><span class="CliReqRecOASpecificDocAtchName fs-6"></span></u></b></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="height: 800px; overflow-y: scroll;">
                <div class="CliReqRecOASpecific_vDocAtchArchCollection"></div>
                <embed id="CliReqRecOASpecific_vDocAtchArchIframe" name="CliReqRecOASpecific_vDocAtchArchIframe" width="100%" height="80%" style="background:url(../assets/img/denrloadsmaller.webp) center center no-repeat;">
                <div class="CliReqRecOASpecific_other_req_inputs"></div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="CliReqRecOASpecificModal" tabindex="-1" aria-labelledby="CliReqRecOASpecificLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h1 class="modal-title fs-5 text-white" id="CliReqRecOASpecificLabel">REQUEST INFORMATION</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="text-center fs-3 border border-3 CliReqRecOASpecificheader-status">
                STATUS UNKNOWN
            </div>
            ...
            <div class="modal-body p-0">
                ...
                {{-- region accordian --}}
                <div class="accordion" id="CliReqRecOASpecific_accordian">
                    {{-- GENERAL INFORMATION --}}
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed border-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#CliReqRecOASpecific_collapsible_gen_info" aria-expanded="true" aria-controls="CliReqRecOASpecific_collapsible_gen_info">
                                GENERAL INFORMATION
                            </button>
                        </h2>
                        <div id="CliReqRecOASpecific_collapsible_gen_info" class="accordion-collapse collapse" data-bs-parent="#CliReqRecOASpecific_accordian">
                            <div class="accordion-body">
                                <div class="row CliReqRecOASpecific-content">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#CliReqRecOASpecific_collapsible_req_info" aria-expanded="false" aria-controls="CliReqRecOASpecific_collapsible_req_info">
                                REQUESTEE INPUTS AND ATTACHMENTS
                            </button>
                        </h2>
                        <div id="CliReqRecOASpecific_collapsible_req_info" class="accordion-collapse collapse" data-bs-parent="#CliReqRecOASpecific_accordian">
                            <div class="accordion-body">
                                <div class="row CliReqRecOASpecific_doc_inpts">
                    ...
                    {{-- region form inputs --}}
                    <form class="p-0" id="addCliReqRecOASpecificForm">
                        {{-- PAYMENT STATUS --}}
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#CliReqRecOASpecific_collapsible_pymnt_stat" aria-expanded="false" aria-controls="CliReqRecOASpecific_collapsible_pymnt_stat">
                                    PAYMENT STATUS
                                </button>
                            </h2>
                            <div id="CliReqRecOASpecific_collapsible_pymnt_stat" class="accordion-collapse collapse" data-bs-parent="#CliReqRecOASpecific_accordian">
                                <div class="accordion-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="row m-3 border border-secondary">
                                                        ...
                                                        @if ($acc_id == 10 || $acc_id == 11 || $acc_id == 12 || $acc_id == 14)
                                                            <div class="col-6">
                                                                <div class="row pe-4">
                                                                    ...
                                                                    <div class="p-0 col-3 border-bottom border-dark fw-bold CliReqRecOASpecific_per_bill_no"></div>
                                                                    <div class="p-0 col-1"></div>
                                                                    <div class="p-0 col-2 text-end">Dated: &nbsp;</div>
                                                                    <div class="p-0 col-4 border-bottom border-dark fw-bold CliReqRecOASpecific_per_bill_no_dated"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6"></div>
                                                ...
                                                <div class="col-12 px-5 CliReqRecOASpecific_prev_cost_breakdown"></div>
                                                <div class="col-12 px-5 pb-3 CliReqRecOASpecific_prev_ttl_cost"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div class="row">
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOASpecific_ttlDays_ttl_tat btn btn-primary"></span>
                                </div>
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOASpecific_ttlHours_ttl_tat btn btn-primary"></span>
                                </div>
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOASpecific_ttlMinutes_ttl_tat btn btn-primary"></span>
                                </div>
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOASpecific_ttlSeconds_ttl_tat btn btn-primary"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row m-3 text-center">
                    <button class="btn btn-outline-primary border-0 CliReqRecOASpecificscrollToTop">Return to top</button>
                    <script>
                        $(document).ready(function() {
                            $('.CliReqRecOASpecificscrollToTop').click(function() {
                                $('#CliReqRecOASpecificModal').scrollTop(0);
                            });
                        });
                    </script>
                </div>
...
@if (request()->has('active_tab'))
    ...
    @endphp
    <input type="hidden" id="dtCliReqRecOASpecific_loader" @if ($active_tab == 'tabCliReqRecOASpecific') value="load" @endif>
@endif
...
<script>
    $(function() {
        // region populate table
        function dtCliReqRecOASpecific_func() {
            // Setup - add a text input to each footer cell
            $('#dtCliReqRecOASpecific tfoot th').each(function() {
                let title = $(this).text();
                $(this).html('<input type="text" style="width: 100%;" placeholder="Search ' + title + '" />');
            });
            $('#dtCliReqRecOASpecific').dataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    "url": "get-specificClientReqsReceivedOrigin",
                    "type": "POST",
                    "headers": {
                    ...
                    /* doc_no */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let more_info = '' +
                                ...
                                '   class="btn-fetchdocInfo_CliReqRecOASpecific dropdown-item" ' +
                                '   data-bs-toggle="modal" ' +
                                '   data-bs-target="#CliReqRecOASpecificModal"' +
                            ...
                            if (row['doc_no'] != 'unset') {
                                ...
                                copyToClipBoard = '<li><a class="dropdown-item admin-dash-mng-cli-req-copy-to-clipboard" style="cursor: pointer" data-val="' + row['doc_no'] + '" ><i class="fa fa-clipboard" aria-hidden="true"></i> Copy to clipboard</a></li>';
                            } else {
                    ...
                    /* client_name */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let dropdownMenu = '' +
                                ...
                                '               <button ' +
                                '                  type="button" ' +
                                '                  class="btnCliReqRecOASpecific-viewClientId btn btn-outline-primary btn-sm" ' +
                                '                  data-bs-toggle="modal" ' +
                                '                  data-bs-target="#CliReqRecOASpecificviewClientIdModal"' +
                    ...
                    /* document attachments */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            req_attachments.forEach(dt => {
                                disp += '' +
                                    '<span ' +
                                    '   class="btnCliReqRecOASpecific-viewDocAtch mb-1" ' +
                                    '   style="cursor: pointer;" ' +
                                    '   onMouseOut="this.style.color=`#000`" ' +
                                    '   onMouseOver="this.style.color=`#0d6efd`" ' +
                                    '   data-bs-toggle="modal" ' +
                                    '   data-bs-target="#CliReqRecOASpecificvDocAtchRcvModal"' +
                                    '   data-file_type="doc" ' +
                                    '   data-doc_id="' + row['id'] + '" ' +
                            ...
                            let req_atchs_collapsible = '' +
                                ...
                                '    <a class="fs-6" data-bs-toggle="collapse" href="#doc_clps_atch_btnCliReqRecOASpecific' + row['id'] + '" role="button" aria-expanded="false" aria-controls="doc_clps_atch_btnCliReqRecOASpecific' + row['id'] + '">' +
                                '        Show Files' +
                                '    </a>' +
                                '</p>' +
                                '<div class="collapse" id="doc_clps_atch_btnCliReqRecOASpecific' + row['id'] + '">' +
                            ...
                            return '' +
                                ...
                                '       <input type="hidden" id="CliReqRecOASpecificdoc_fileCollection' + row['id'] + '" value="' + file_names + '">' +
                                '   </div>' +
                                '</div>' +
                                '';
                        }
                    ...
                    /* action Attachments */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            act_attachments.forEach(dt => {
                                disp += '' +
                                    '<span ' +
                                    '   class="btnCliReqRecOASpecific-viewDocAtch" ' +
                                    '   style="cursor: pointer;" ' +
                                    '   onMouseOut="this.style.color=`#000`" ' +
                                    '   onMouseOver="this.style.color=`#0d6efd`" ' +
                                    '   data-bs-toggle="modal" ' +
                            ...
                            let req_atchs_collapsible = '' +
                                '<p class="d-inline-flex gap-1">' +
                                '    <a class="fs-6" data-bs-toggle="collapse" href="#act_clps_atch_btnCliReqRecOASpecific' + row['id'] + '" role="button" aria-expanded="false" aria-controls="act_clps_atch_btnCliReqRecOASpecific' + row['id'] + '">' +
                                '        Show Files' +
                                '    </a>' +
                                '</p>' +
                                '<div class="collapse" id="act_clps_atch_btnCliReqRecOASpecific' + row['id'] + '">' +
                                '    <div class="card card-body">' +
                                '       ' + disp +
                                '    </div>' +
                                '</div>' +
                            ...
                            return '' +
                                ...
                                '       ' + attachment_remarks +
                                '       ' + req_atchs_collapsible +
                                '       <input type="hidden" id="CliReqRecOASpecificact_fileCollection' + row['id'] + '" value="' + file_names + '">' +
                                '   </div>' +
                                '</div>' +
                                '';
                        }
                ...
                buttons: [
                    'pageLength',
                    {
                        ...
                        title: `OVERALL RECEIVED CLIENT REQUESTS INCLUDING RELEASED, ARCHIVED, AND REJECTED REQUEST BY THE USER ${new Date().toLocaleDateString()}`,
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
                    {
                        ...
                        customize: function(win) {
                            ...
                            $(win.document.body).find('h1').parent().prepend('' +
                                ...
                                '</div>' +
                                '<div style="text-align: center; font-size: 15pt;">' +
                                '   <h2>OVERALL RECEIVED CLIENT REQUESTS INCLUDING RELEASED,<br>ARCHIVED, AND REJECTED REQUEST BY THE USER</h2>' +
                                '   <sup>User: ' + auth_username + '</sup><br>' +
                                '</div>'
                            );
                            // $(win.document.body).find('table thead').remove();
                            // $(win.document.body).find('table').prepend($('#dtCliReqRecOASpecific thead').clone());
                            $(win.document.body).find('table tbody').remove();
                            $(win.document.body).find('table').append($('#dtCliReqRecOASpecific tbody').clone());
                        }
                    },
                    {
                        extend: 'copy',
                    ...
                    'colvis',
                    {
                        ...
                        text: '<input class="form-control form-control-sm border-0 dtCliReqRecOASpecific_search" type="text" placeholder="Search">',
                        action: function(e, dt, node, config) {
                            let searchValue = $(node).find('.dtCliReqRecOASpecific_search').val();
        ...
        let tabCliReqRecOASpecific = false;
        $('label[for=tabCliReqRecOASpecific]').click(function() {
            if (tabCliReqRecOASpecific == false) {
                dtCliReqRecOASpecific_func();
                tabCliReqRecOASpecific = true;
            }
        });

        if ($('#dtCliReqRecOASpecific_loader').val() == 'load') {
            if (tabCliReqRecOASpecific == false) {
                dtCliReqRecOASpecific_func();
                tabCliReqRecOASpecific = true;
            }
        ...
        $('#dtCliReqRecOASpecific_wrapper .btn-group button').removeClass('btn-secondary').addClass('btn-outline-success');
    });
</script>
{{-- endregion populate table --}}
...
<script>
    $(function() {
        ...
        $('#dtCliReqRecOASpecific').on('click', '.btnCliReqRecOASpecific-viewClientId', function() {
            let username = $('#auth_username').val();
            let client_id = $(this).data('client_id');

            let iframeHref = '/get-clientId-view/' + username + '/' + client_id + '/';
            $('#CliReqRecOASpecificviewClientIdIframe').attr('src', iframeHref);
            $('#CliReqRecOASpecificreencryptId').val(client_id);
        });
        // endregion view client id

        // region view document attachment
        $('#dtCliReqRecOASpecific').on('click', '.btnCliReqRecOASpecific-viewDocAtch', function() {
            let username = $('#auth_username').val();
            ...
            if (file_type == 'doc') {
                ...
                let fileCollection = $('#dtCliReqRecOASpecific #CliReqRecOASpecificdoc_fileCollection' + id).val();
                ...
                $('.CliReqRecOASpecific_vDocAtchArchCollection').empty()
                fileCollection_arr.filter(item => {
                    if (item != '') {
                        $('.CliReqRecOASpecific_vDocAtchArchCollection').append('' + '<button class="btnCliReqRecOASpecific-view-file btn btn-outline-primary btn-sm border-0 m-1" data-file_path="' + file_path + '" data-file_name="' + item + '">' + collection_count + '. ' + item + '</button> <a href="/' + file_path + '/' + item + '" target="_blank" tooltip="Open in separate tab" flow="right"> <i class="fa fa-external-link" aria-hidden="true"></i> </a><br>');
                        collection_count += 1;
                    }
                });
                ...
                let content2 = $('#CliReqRecOASpecific_vDocAtchArchIframe').attr('src');
                if (content1 != content2) {
                    $('.CliReqRecOASpecificDocAtchName').empty().append(file_name);
                    $('#CliReqRecOASpecific_vDocAtchArchIframe').attr('src', iframeHref + '#toolbar=0');
                }

                // get other requestee input
                $('.CliReqRecOASpecific_other_req_inputs').empty()
                $.ajax({
                    ...
                    success: function(r) {
                        if (r.success) {
                            $('.CliReqRecOASpecific_other_req_inputs').append('<hr><h6>Other Requestee Input:</h6><br>');
                            console.log(r.req_inputs);

                            if (r.req_inputs.length >= 1) {
                                r.req_inputs.forEach(dt => {
                                    $('.CliReqRecOASpecific_other_req_inputs').append('' +
                ...
                let fileCollection = $('#dtCliReqRecOASpecific #CliReqRecOASpecificact_fileCollection' + id).val();
        ...
        $('.CliReqRecOASpecific_vDocAtchArchCollection').on('click', '.btnCliReqRecOASpecific-view-file', function() {
        ...
        $('#dtCliReqRecOASpecific').on('click', '.btn-fetchdocInfo_CliReqRecOASpecific', function() {
            ...
            $('#CliReqRecOASpecificaction_id').val(action_id);
            $('#CliReqRecOASpecificdoc_id').val(doc_id);
            ...
            $.ajax({
                ...
                success: function(r) {
                    if (r.success) {
                        ...
                        // region status bar
                        if (validated != null) {
                            $('.CliReqRecOASpecificheader-status').empty().append('<i class="fa fa-check-circle" aria-hidden="true"></i> VERIFIED');
                            $('.CliReqRecOASpecificheader-status').removeClass('border-danger text-danger').addClass('border-success text-success');
                        } else {
                            $('.CliReqRecOASpecificheader-status').empty().append('<i class="fa fa-hourglass" aria-hidden="true"></i> NOT YET VERIFIED');
                            $('.CliReqRecOASpecificheader-status').removeClass('border-success text-success').addClass('border-danger text-danger');
                        }
                        // endregion status bar

                        $('.CliReqRecOASpecific-content').empty().append('' +
                        ...
                        $('.CliReqRecOASpecific-content').append('' +
                        ...
                        $('#CliReqRecOASpecificremarks').val(remarks);

                        // region document attachments and inputs
                        let filecount = 0;
                        let inptcount = 0;
                        let app_doc_form_no = 0; //appform start from 0 
                        $('.CliReqRecOASpecific_doc_atch').empty(); // make sure to empty the list
                        $('.CliReqRecOASpecific_doc_inpts').empty(); // make sure to empty the list
                        doc_attachments.forEach(dt => {
                            ...
                            if (dt.attachment_type == 'file') {
                                ...
                                if (app_doc_form_no != dt.app_form_no) {
                                    $('.CliReqRecOASpecific_doc_inpts').append('' +
                        ...
                        if (filecount == 0) {
                            $('.CliReqRecOASpecific_doc_atch').append('' +
                                '--- no attachment found ---'
                            );
                        }
                        /* if (inptcount == 0) {
                        ...
                        $('.CliReqRecOASpecific_ttlDays_ttl_tat').empty().text(ttlDays_ttl_tat + ' Days');
                        $('.CliReqRecOASpecific_ttlHours_ttl_tat').empty().text(ttlHours_ttl_tat + ' Hours');
                        $('.CliReqRecOASpecific_ttlMinutes_ttl_tat').empty().text(ttlMinutes_ttl_tat + ' Minutes');
                        $('.CliReqRecOASpecific_ttlSeconds_ttl_tat').empty().text(ttlSeconds_ttl_tat + ' Seconds');
                        // endregion document status
                        ...
                        if (order_of_payment != null) {
                            //perbill
                            $('.CliReqRecOASpecific_per_bill_no').empty().append(order_of_payment.per_bill_no);
                            $('.CliReqRecOASpecific_per_bill_no_dated').empty().append(order_of_payment.per_bill_no_dated);

                            //cost
                            if (cost_breakdown.length != 0) {
                                $('.CliReqRecOASpecific_prev_cost_breakdown').empty().append('' +
                                ...
                                cost_breakdown.forEach(dt => {
                                    $('.CliReqRecOASpecific_prev_cost_breakdown').append('' +
                                        '<div class="row cb_item"> ' +
                                ...
                                if (total_of_cost_break_down == order_of_payment.pay_amount) {
                                    $('.CliReqRecOASpecific_prev_ttl_cost').empty().append('' +
                                        ...
                                        '        PHP ' + order_of_payment.pay_amount + '.00 ' +
                                        '    </div> ' +
                                        '</div> ' +
                                        ''
                                    );
                            ...
                            $('.CliReqRecOASpecific_prev_cost_breakdown').empty();
                            $('.CliReqRecOASpecific_prev_ttl_cost').empty().append('' +
                                '<div class="row ttl_item"> ' +
                                '    <div class="col-12 text-center fs-6 fw-bold"> ' +
        ...
        $('.btn-CliReqRecOASpecificreencryptId').click(function() {
            let client_id = $('#CliReqRecOASpecificreencryptId').val();
        ...
        $.ajax({
            ...
            success: function(r) {
                if (r.success) {
                    $('.viewer-assigned-msg').empty().append('' +
                        '<div class="alert alert-success" role="alert">' +
                        '   Displaying all records submited to ' + r.full_office_name +
                        '</div>'
                    );

                } else {
                    console.log("No viewer has been assigned");

                    $('.viewer-assigned-msg').empty().append('<div class="alert alert-danger" role="alert">' +
                        'No viewer has been assigned' +
                        '</div>'
                    );
                }
            },
