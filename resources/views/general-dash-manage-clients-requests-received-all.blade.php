...
<table class="table table-striped table-bordered dataTable " id="dtCliReqRecOA" role="grid" aria-describedby="Table" style="width: 100%;" cellspacing="0" width="100%">
...
<div class="modal fade" id="CliReqRecOAviewClientIdModal" tabindex="-1" aria-labelledby="CliReqRecOAviewClientIdLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h1 class="modal-title fs-5 text-white" id="CliReqRecOAviewClientIdLabel">Client ID View</h1>
                <button type="button" class="btn-close btn-CliReqRecOAreencryptId" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="height: 800px;">
                <iframe id="CliReqRecOAviewClientIdIframe" name="viewClientIdIframe" href="" style="width: 100%; height: 100%;"></iframe>
            </div>
            <div class="modal-footer">
                <input type="hidden" id="CliReqRecOAreencryptId">
                <button type="button" class="btn btn-secondary btn-CliReqRecOAreencryptId" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="CliReqRecOAvDocAtchRcvModal" tabindex="-1" aria-labelledby="CliReqRecOA_viewDocAtchTransitLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h1 class="modal-title fs-5 text-white" id="CliReqRecOA_viewDocAtchTransitLabel">Document Attachement: <b><u><span class="CliReqRecOADocAtchName fs-6"></span></u></b></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="height: 800px; overflow-y: scroll;">
                <div class="CliReqRecOA_vDocAtchArchCollection"></div>
                <embed id="CliReqRecOA_vDocAtchArchIframe" name="CliReqRecOA_vDocAtchArchIframe" width="100%" height="80%" style="background:url(../assets/img/denrloadsmaller.webp) center center no-repeat;">
                <div class="CliReqRecOA_other_req_inputs"></div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="CliReqRecOAModal" tabindex="-1" aria-labelledby="CliReqRecOALabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h1 class="modal-title fs-5 text-white" id="CliReqRecOALabel">REQUEST INFORMATION</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="text-center fs-3 border border-3 CliReqRecOAheader-status">
                STATUS UNKNOWN
            </div>
            ...
            <div class="modal-body p-0">
                ...
                {{-- region accordian --}}
                <div class="accordion" id="CliReqRecOA_accordian">
                    {{-- GENERAL INFORMATION --}}
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed border-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#CliReqRecOA_collapsible_gen_info" aria-expanded="true" aria-controls="CliReqRecOA_collapsible_gen_info">
                                GENERAL INFORMATION
                            </button>
                        </h2>
                        <div id="CliReqRecOA_collapsible_gen_info" class="accordion-collapse collapse" data-bs-parent="#CliReqRecOA_accordian">
                            <div class="accordion-body">
                                <div class="row CliReqRecOA-content">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#CliReqRecOA_collapsible_req_info" aria-expanded="false" aria-controls="CliReqRecOA_collapsible_req_info">
                                REQUESTEE INPUTS AND ATTACHMENTS
                            </button>
                        </h2>
                        <div id="CliReqRecOA_collapsible_req_info" class="accordion-collapse collapse" data-bs-parent="#CliReqRecOA_accordian">
                            <div class="accordion-body">
                                <div class="row CliReqRecOA_doc_inpts">
                    ...
                    {{-- region form inputs --}}
                    <form class="p-0" id="addCliReqRecOAForm">
                        {{-- PAYMENT STATUS --}}
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#CliReqRecOA_collapsible_pymnt_stat" aria-expanded="false" aria-controls="CliReqRecOA_collapsible_pymnt_stat">
                                    PAYMENT STATUS
                                </button>
                            </h2>
                            <div id="CliReqRecOA_collapsible_pymnt_stat" class="accordion-collapse collapse" data-bs-parent="#CliReqRecOA_accordian">
                                <div class="accordion-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="row m-3 border border-secondary">
                                                        ...
                                                        @if ($acc_id == 10 || $acc_id == 11 || $acc_id == 12 || $acc_id == 14)
                                                            <div class="col-6">
                                                                <div class="row pe-4">
                                                                    ...
                                                                    <div class="p-0 col-3 border-bottom border-dark fw-bold CliReqRecOA_per_bill_no"></div>
                                                                    <div class="p-0 col-1"></div>
                                                                    <div class="p-0 col-2 text-end">Dated: &nbsp;</div>
                                                                    <div class="p-0 col-4 border-bottom border-dark fw-bold CliReqRecOA_per_bill_no_dated"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6"></div>
                                                ...
                                                <div class="col-12 px-5 CliReqRecOA_prev_cost_breakdown"></div>
                                                <div class="col-12 px-5 pb-3 CliReqRecOA_prev_ttl_cost"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div class="row">
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOA_ttlDays_ttl_tat btn btn-primary"></span>
                                </div>
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOA_ttlHours_ttl_tat btn btn-primary"></span>
                                </div>
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOA_ttlMinutes_ttl_tat btn btn-primary"></span>
                                </div>
                                <div class="col-md-3 text-center">
                                    <span class="fs-6 CliReqRecOA_ttlSeconds_ttl_tat btn btn-primary"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row m-3 text-center">
                    <button class="btn btn-outline-primary border-0 CliReqRecOAscrollToTop">Return to top</button>
                    <script>
                        $(document).ready(function() {
                            $('.CliReqRecOAscrollToTop').click(function() {
                                $('#CliReqRecOAModal').scrollTop(0);
                            });
                        });
                    </script>
                </div>
...
@if (request()->has('active_tab'))
    ...
    @endphp
    <input type="hidden" id="dtCliReqRecOA_loader" @if ($active_tab == 'tabCliReqRecOA') value="load" @endif>
@endif
...
<script>
    $(function() {
        // region populate table
        function dtCliReqRecOA_func() {
            // Setup - add a text input to each footer cell
            $('#dtCliReqRecOA tfoot th').each(function() {
                let title = $(this).text();
                $(this).html('<input type="text" style="width: 100%;" placeholder="Search ' + title + '" />');
            });
            $('#dtCliReqRecOA').dataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    "url": "get-specificClientReqsReceivedOverall",
                    "type": "POST",
                    "headers": {
                    ...
                    /* doc_no */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let more_info = '' +
                                ...
                                '   class="btn-fetchdocInfo_CliReqRecOA dropdown-item" ' +
                                '   data-bs-toggle="modal" ' +
                                '   data-bs-target="#CliReqRecOAModal"' +
                    ...
                    /* client_name */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let dropdownMenu = '' +
                                ...
                                '               <button ' +
                                '                  type="button" ' +
                                '                  class="btnCliReqRecOA-viewClientId btn btn-outline-primary btn-sm" ' +
                                '                  data-bs-toggle="modal" ' +
                                '                  data-bs-target="#CliReqRecOAviewClientIdModal"' +
                    ...
                    /* document attachments */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            req_attachments.forEach(dt => {
                                disp += '' +
                                    '<span ' +
                                    '   class="btnCliReqRecOA-viewDocAtch mb-1" ' +
                                    '   style="cursor: pointer;" ' +
                                    '   onMouseOut="this.style.color=`#000`" ' +
                                    '   onMouseOver="this.style.color=`#0d6efd`" ' +
                                    '   data-bs-toggle="modal" ' +
                                    '   data-bs-target="#CliReqRecOAvDocAtchRcvModal"' +
                                    '   data-file_type="doc" ' +
                                    '   data-doc_id="' + row['id'] + '" ' +
                            ...
                            let req_atchs_collapsible = '' +
                                ...
                                '    <a class="fs-6" data-bs-toggle="collapse" href="#doc_clps_atch_btnCliReqRecOA' + row['id'] + '" role="button" aria-expanded="false" aria-controls="doc_clps_atch_btnCliReqRecOA' + row['id'] + '">' +
                                '        Show Files' +
                                '    </a>' +
                                '</p>' +
                                '<div class="collapse" id="doc_clps_atch_btnCliReqRecOA' + row['id'] + '">' +
                            ...
                            return '' +
                                ...
                                '       <input type="hidden" id="CliReqRecOAdoc_fileCollection' + row['id'] + '" value="' + file_names + '">' +
                                '   </div>' +
                                '</div>' +
                                '';
                        }
                    ...
                    /* action Attachments */
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            act_attachments.forEach(dt => {
                                disp += '' +
                                    '<span ' +
                                    '   class="btnCliReqRecOA-viewDocAtch" ' +
                                    '   style="cursor: pointer;" ' +
                                    '   onMouseOut="this.style.color=`#000`" ' +
                                    '   onMouseOver="this.style.color=`#0d6efd`" ' +
                                    '   data-bs-toggle="modal" ' +
                            ...
                            let req_atchs_collapsible = '' +
                                '<p class="d-inline-flex gap-1">' +
                                '    <a class="fs-6" data-bs-toggle="collapse" href="#act_clps_atch_btnCliReqRecOA' + row['id'] + '" role="button" aria-expanded="false" aria-controls="act_clps_atch_btnCliReqRecOA' + row['id'] + '">' +
                                '        Show Files' +
                                '    </a>' +
                                '</p>' +
                                '<div class="collapse" id="act_clps_atch_btnCliReqRecOA' + row['id'] + '">' +
                                '    <div class="card card-body">' +
                                '       ' + disp +
                                '    </div>' +
                                '</div>' +
                            ...
                            return '' +
                                ...
                                '       ' + attachment_remarks +
                                '       ' + req_atchs_collapsible +
                                '       <input type="hidden" id="CliReqRecOAact_fileCollection' + row['id'] + '" value="' + file_names + '">' +
                                '   </div>' +
                                '</div>' +
                                '';
                        }
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        customize: function(win) {
                            ...
                            // $(win.document.body).find('table').prepend($('#dtCliReqRecOA thead').clone());
                            $(win.document.body).find('table tbody').remove();
                            $(win.document.body).find('table').append($('#dtCliReqRecOA tbody').clone());
                        }
                    },
                    {
                        extend: 'copy',
                    ...
                    'colvis',
                    {
                        ...
                        text: '<input class="form-control form-control-sm border-0 dtCliReqRecOA_search" type="text" placeholder="Search">',
                        action: function(e, dt, node, config) {
                            let searchValue = $(node).find('.dtCliReqRecOA_search').val();
        ...
        let tabCliReqRecOA = false;
        $('label[for=tabCliReqRecOA]').click(function() {
            if (tabCliReqRecOA == false) {
                dtCliReqRecOA_func();
                tabCliReqRecOA = true;
            }
        });

        if ($('#dtCliReqRecOA_loader').val() == 'load') {
            if (tabCliReqRecOA == false) {
                dtCliReqRecOA_func();
                tabCliReqRecOA = true;
            }
        ...
        $('#dtCliReqRecOA_wrapper .btn-group button').removeClass('btn-secondary').addClass('btn-outline-success');
    });
</script>
{{-- endregion populate table --}}
...
<script>
    $(function() {
        ...
        $('#dtCliReqRecOA').on('click', '.btnCliReqRecOA-viewClientId', function() {
            let username = $('#auth_username').val();
            let client_id = $(this).data('client_id');

            let iframeHref = '/get-clientId-view/' + username + '/' + client_id + '/';
            $('#CliReqRecOAviewClientIdIframe').attr('src', iframeHref);
            $('#CliReqRecOAreencryptId').val(client_id);
        });
        // endregion view client id

        // region view document attachment
        $('#dtCliReqRecOA').on('click', '.btnCliReqRecOA-viewDocAtch', function() {
            let username = $('#auth_username').val();
            ...
            if (file_type == 'doc') {
                ...
                let fileCollection = $('#dtCliReqRecOA #CliReqRecOAdoc_fileCollection' + id).val();
                ...
                let content2 = $('#CliReqRecOA_vDocAtchArchIframe').attr('src');
                if (content1 != content2) {
                    $('.CliReqRecOADocAtchName').empty().append(file_name);
                    $('#CliReqRecOA_vDocAtchArchIframe').attr('src', iframeHref + '#toolbar=0');
                }

                // get other requestee input
                $('.CliReqRecOA_other_req_inputs').empty()
                $.ajax({
                    ...
                    success: function(r) {
                        if (r.success) {
                            $('.CliReqRecOA_other_req_inputs').append('<hr><h6>Other Requestee Input:</h6><br>');
                            console.log(r.req_inputs);

                            if (r.req_inputs.length >= 1) {
                                r.req_inputs.forEach(dt => {
                                    $('.CliReqRecOA_other_req_inputs').append('' +
                ...
                let fileCollection = $('#dtCliReqRecOA #CliReqRecOAact_fileCollection' + id).val();
        ...
        $('.CliReqRecOA_vDocAtchArchCollection').on('click', '.btnCliReqRecOA-view-file', function() {
        ...
        $('#dtCliReqRecOA').on('click', '.btn-fetchdocInfo_CliReqRecOA', function() {
            ...
            $('#CliReqRecOAaction_id').val(action_id);
            $('#CliReqRecOAdoc_id').val(doc_id);
            ...
            $.ajax({
                ...
                success: function(r) {
                    if (r.success) {
                        ...
                        // region status bar
                        if (validated != null) {
                            $('.CliReqRecOAheader-status').empty().append('<i class="fa fa-check-circle" aria-hidden="true"></i> VERIFIED');
                            $('.CliReqRecOAheader-status').removeClass('border-danger text-danger').addClass('border-success text-success');
                        } else {
                            $('.CliReqRecOAheader-status').empty().append('<i class="fa fa-hourglass" aria-hidden="true"></i> NOT YET VERIFIED');
                            $('.CliReqRecOAheader-status').removeClass('border-success text-success').addClass('border-danger text-danger');
                        }
                        // endregion status bar

                        $('.CliReqRecOA-content').empty().append('' +
                        ...
                        $('#CliReqRecOAremarks').val(remarks);

                        // region document attachments and inputs
                        let filecount = 0;
                        let inptcount = 0;
                        let app_doc_form_no = 0; //appform start from 0 
                        $('.CliReqRecOA_doc_atch').empty(); // make sure to empty the list
                        $('.CliReqRecOA_doc_inpts').empty(); // make sure to empty the list
                        ...
                        $('.CliReqRecOA_ttlDays_ttl_tat').empty().text(ttlDays_ttl_tat + ' Days');
                        $('.CliReqRecOA_ttlHours_ttl_tat').empty().text(ttlHours_ttl_tat + ' Hours');
                        $('.CliReqRecOA_ttlMinutes_ttl_tat').empty().text(ttlMinutes_ttl_tat + ' Minutes');
                        $('.CliReqRecOA_ttlSeconds_ttl_tat').empty().text(ttlSeconds_ttl_tat + ' Seconds');
                        // endregion document status
                        ...
                        if (order_of_payment != null) {
                            //perbill
                            $('.CliReqRecOA_per_bill_no').empty().append(order_of_payment.per_bill_no);
                            $('.CliReqRecOA_per_bill_no_dated').empty().append(order_of_payment.per_bill_no_dated);

                            //cost
                            if (cost_breakdown.length != 0) {
                                $('.CliReqRecOA_prev_cost_breakdown').empty().append('' +
                                ...
                                cost_breakdown.forEach(dt => {
                                    $('.CliReqRecOA_prev_cost_breakdown').append('' +
                                        '<div class="row cb_item"> ' +
                                ...
                                if (total_of_cost_break_down == order_of_payment.pay_amount) {
                                    $('.CliReqRecOA_prev_ttl_cost').empty().append('' +
                            ...
                            $('.CliReqRecOA_prev_cost_breakdown').empty();
                            $('.CliReqRecOA_prev_ttl_cost').empty().append('' +
                                '<div class="row ttl_item"> ' +
        ...
        $('.btn-CliReqRecOAreencryptId').click(function() {
            let client_id = $('#CliReqRecOAreencryptId').val();
