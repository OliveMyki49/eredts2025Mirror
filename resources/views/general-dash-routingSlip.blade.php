                                    ...
                                    <td class="m-0 p-0 text-center">
                                        ...
                                        <div style="position: relative">
                                            <div class="d-flex justify-content-end" style="position: absolute; top: -15px; left:15%;">
                                                <img src="{{ asset('assets/img/denrlogoplain.png') }}" class="navbar-brand-img h-2 v-2" alt="main_logo" width="90px" height="90px">
                                            </div>
                            ...
                            <table class="my-3 p-0">
                                <tr class="m-0 p-0">
                                    <td class="m-0 ps-1 text-center">
                                        <h5><b>REGIONAL FRONTLINE SERVICES ONLINE APPLICATION AND TRACKING SYSTEM</b></h5>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        $(function() {
            ...
            var demoParams = [{
                ...
                config: {
                    ...
                    logo: "/assets/img/denrlogoplain.png",
