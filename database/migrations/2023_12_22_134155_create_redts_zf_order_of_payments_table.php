...
return new class extends Migration
{
    ...
    {
        Schema::create('redts_zf_order_of_payments', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('order_of_payment', 255)->nullable();
            $table->string('payment_receipt', 255)->nullable();
            $table->timestamp('payment_receipt_date')->nullable();
