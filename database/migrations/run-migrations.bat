...
php artisan migrate --path=database\migrations\2024_03_07_144649_create_redts_zfa_additional_oops_table.php

php artisan migrate --path=database\migrations\2024_03_07_151656_create_redts_zga_other_pymnt_cost_brkdwns_table.php
